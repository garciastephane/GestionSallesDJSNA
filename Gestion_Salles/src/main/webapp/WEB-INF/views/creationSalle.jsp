...
<body>
	...
	<p class="text-secondary">
		...
		<label>Nom de batiment : </label> 
				<select name="batiment" id="selectNomBatiment">
		...
		<select name="type" id="selectNomBatiment">
		...
		<label>Numero de salle : </label>
		 		<input type="text" name="numsalle" id="num">
			<br>
		<label>Surface (m²) : </label> 
				<input type="number" name="surface" id="num">
			<br>
		<label>Capacite : </label>
				<input type="number" name="capacite" id="num">
